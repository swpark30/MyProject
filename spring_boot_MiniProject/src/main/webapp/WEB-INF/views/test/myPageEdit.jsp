				...
				<form method="post" class="EditFrm" name="EditFrm">
					<div class="inputBox">
						<div class="windowFontBox">
							...
							<div class="inputEvent">
								<input type="text" class="nameInput" value="${user.userName }" readonly placeholder="이름 변경 불가">
								<i></i>
							</div><!--inputEvent  -->
						</div> <!-- "windowFontBox" -->	
					...
					<div class="nickNameInputBox">
						<div class="windowFontBox">
							<span>닉네임</span>
							<div class="inputEvent">
								<input type="text" class="nicknameInput" value="${user.userNickname }">
								<i></i>
							</div> <!-- inputEvent -->
						</div> <!-- "windowFontBox" -->
					...
					<div class="idInputBox">
						<div class="windowFontBox">
							<span>아이디</span>
							<div class="inputEvent">
								<input type="text" class="idInput" value="${user.userId }" readonly placeholder="아이디 변경 불가">
								<i></i>
							</div> <!-- inputEvent -->	
						</div> <!-- "windowFontBox" -->
					</div> <!-- idInputBox -->
						...
						<div class="emailBox">
							<div class ="windowFontBox"> 	
								<span>이메일</span>
								<div class="inputEvent">
									<input type="text" value="${user.userEmail }" class="emailInput">
									<i></i>
								</div> <!-- inputEvent -->
								&nbsp;&nbsp;
							</div> <!-- windowFontBox -->
